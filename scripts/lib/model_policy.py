...
class ModelPolicy(Mapping[str, Any]):
    ...
    coordination_fix: str = "gpt-5.4-high"
    coordination_bridge: str = "gpt-5.4-xhigh"
    exploration: str = "glm"
    adjudicator: str = "glm"
    ...
    substrate_shard: str = "gpt-5.4-high"
    substrate_pruner: str = "gpt-5.4-xhigh"
    substrate_seeder: str = "gpt-5.4-high"
